...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/phientram/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Phien Tram' => 'phientram@me.com' }
  s.source           = { :git => 'https://github.com/phientram/BlinkingLabel.git', :tag => s.version.to_s }
